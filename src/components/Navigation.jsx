...
//NavLink: composant fourni par React Router pour créer des liens
// de navigation dans une application React. 

//to="/": C'est la prop to de NavLink. Elle spécifie la destination vers
// laquelle le lien doit rediriger. 
...
//qui sera appliquée au lien. Fonction fléchée qui prend un argument isActive. 
